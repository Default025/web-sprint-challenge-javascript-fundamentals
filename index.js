...
/* The nested function is able to grab the variable because it is within the outer function, the outer function cannot grab a variable from the nested one though, */
...
console.log(consume(`Chris`, `Daily`, greeting));
